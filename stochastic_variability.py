...
# NMI (Normalized Mutual Information) -> Measures similarity
# VI (Variation of Information) -> Measures dissimilarity
# RI (Rand Index) -> Measures agreement
...
# Comparison of NMI, VI, and RI distributions helps understand how well communities are detected in each graph type.
